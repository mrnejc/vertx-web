...
public class HandlebarsTemplateTest extends WebTestBase {
  ...
  @Test
  public void testTemplateWithPartialFromSubpath() throws Exception {
    TemplateEngine engine = HandlebarsTemplateEngine.create();
    testTemplateHandler(engine, "src/test/filesystemtemplates", "subpath/test-handlebars-template9", "\ntext from template8\n\ntext from template9\n\n\n");
  }
